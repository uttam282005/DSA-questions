...
void solve() {
  ...
  cin >> n;
  /* A = 21, b = 18, c = 25 */
  int plancks_for_a = (n + 1) / 2;
  int a_last = n % 2;
  int b_left = n - plancks_for_a - a_last;
  int plancks_for_b = (b_left + 2) / 3;
  int b_last = b_left % 3;
  int c_left = n;
  if (b_last == 1)
    c_left--;
  int plancks_for_c = (c_left + 1) / 2;
  ll ans = plancks_for_a + plancks_for_b + plancks_for_c;
  cout << ans << endl;
}
